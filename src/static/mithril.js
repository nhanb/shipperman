    ...
    function isFormAttribute(vnode3, attr) {
      return (
        ...
        (attr === "selected" &&
          (vnode3.dom === activeElement(vnode3.dom) ||
            (vnode3.tag === "option" &&
              vnode3.dom.parentNode === activeElement(vnode3.dom))))
      );
    }
  ...
  var censor = function (attrs4, extras) {
    ...
    if (extras != null) {
      for (var key6 in attrs4) {
        if (
          hasOwn.call(attrs4, key6) &&
          !magic.test(key6) &&
          extras.indexOf(key6) < 0
        ) {
